 ...
 *
 * IDENTIFICATION
 *	  $Header: /project/eecs/db/cvsroot/postgres/src/interfaces/libpq/fe-misc.c,v 1.3 2004/03/24 08:11:34 chungwu Exp $
 *
 *-------------------------------------------------------------------------
 */
...
retry5:
		...
		{
			/*
			 * Set up delay.  Assume caller incremented finish_time so
			 * that we can error out as soon as time() passes it. Note we
			 * will recalculate delay each time through the loop.
			 */
