...
/* $Header: /project/eecs/db/cvsroot/postgres/src/interfaces/jdbc/org/postgresql/jdbc2/AbstractJdbc2Statement.java,v 1.3 2004/03/24 08:11:32 chungwu Exp $
...
public abstract class AbstractJdbc2Statement extends org.postgresql.jdbc1.AbstractJdbc1Statement
{
	...
	{
      // if the Fetchsize is forced, ignore setting it.
      if (((AbstractJdbc1Connection) connection).forceFetchSize)
         return;
      super.m_fetchSize = rows;
	}
