 ...
 *
 * IDENTIFICATION
 *	  $Header: /project/eecs/db/cvsroot/postgres/src/backend/rewrite/rewriteManip.c,v 1.7 2004/03/24 08:11:06 chungwu Exp $
 *
 *-------------------------------------------------------------------------
 */
#include "postgres.h"
...
ChangeVarNodes_walker(Node *node, ChangeVarNodes_context *context)
{
	...
	if (IsA(node, Var))
	{
		...
		else if (var->varlevelsup == context->sublevels_up &&	/* @BdjoinSK */
				 var->varnoold == context->rt_index)
		{
			var->varnoold = context->new_index;
		}						/* @EdjoinSK */
		return false;
