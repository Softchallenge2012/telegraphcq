 ...
 *
 * IDENTIFICATION
 *	  $Header: /project/eecs/db/cvsroot/postgres/src/backend/rewrite/rewriteHandler.c,v 1.3 2004/03/24 08:11:06 chungwu Exp $
 *
 *-------------------------------------------------------------------------
 */
#include "postgres.h"
...
build_column_default(Relation rel, int attrno)
{
	...
	/*
	 * This really shouldn't fail; should have checked the default's type
	 * when it was created ...
	 */
	if (expr == NULL)
