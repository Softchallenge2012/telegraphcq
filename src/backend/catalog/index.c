 ...
 *
 * IDENTIFICATION
 *	  $Header: /project/eecs/db/cvsroot/postgres/src/backend/catalog/index.c,v 1.9 2004/03/24 08:10:51 chungwu Exp $
 *
 *
 * INTERFACE ROUTINES
					...
					bool primary)
{
	 ...
	 *
	 * (zero filling is essential 'cause we don't store the number of index
	 * columns explicitly in pg_index, which is pretty grotty...)
	 */
