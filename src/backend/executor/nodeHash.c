 ...
 *
 *
 *	$Id: nodeHash.c,v 1.3 2003/07/17 05:18:46 sailesh Exp $
 *
 *-------------------------------------------------------------------------
 */
/*
...
uint32		hashFunc(Datum key, int typLen, bool byVal);
						...
						int *numbatches)
{
	...
	else
	{
		 ...
		 * batches the same size.  But we have to keep nbatch small enough
		 * to avoid integer overflow in ExecHashJoinGetBatch().
		 */
