 ...
 *
 * IDENTIFICATION
 *	  $Header: /project/eecs/db/cvsroot/postgres/src/backend/storage/freespace/freespace.c,v 1.3 2004/03/24 08:11:07 chungwu Exp $
 *
 *
 * NOTES:
 *
					 ...
					 PageFreeSpaceInfo * pageSpaces)
{
	...
	if (fsmrel)
	{
		 ...
		 *
		 * This can be much cheaper than a full fsm_record_free_space() call
		 * because we know we are appending to the end of the relation.
		 */
		for (i = 0; i < nPages; i++)
		{
