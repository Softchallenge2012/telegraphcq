 ...
 *
 * IDENTIFICATION
 *	  $Header: /project/eecs/db/cvsroot/postgres/src/backend/commands/prepare.c,v 1.3 2004/03/24 08:10:52 chungwu Exp $
 *
 *-------------------------------------------------------------------------
 */
#include "postgres.h"
...
PrepareQuery(PrepareStmt *stmt)
{
	...
	foreach(query_list_item, query_list)
	{
		...
		plan = pg_plan_query(query, CurrentMemoryContext);
