 ...
 *
 * IDENTIFICATION
 *	  $Header: /project/eecs/db/cvsroot/postgres/src/backend/access/index/indexam.c,v 1.3 2004/03/24 08:10:48 chungwu Exp $
 *
 * INTERFACE ROUTINES
...
index_getnext(IndexScanDesc scan, ScanDirection direction)
{
	 ...
	 * must be unique.	Instead, we need a "short circuit" path that just
	 * keeps track of logical scan position (before/on/after tuple).
	 *
	 * Note that we hold the pin on the single tuple's buffer throughout the
	 * scan once we are in this state.
	 */
