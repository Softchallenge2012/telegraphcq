 ...
 *
 * IDENTIFICATION
 *	  $Header: /project/eecs/db/cvsroot/postgres/src/backend/utils/sort/tuplesort.c,v 1.3 2004/03/24 08:11:20 chungwu Exp $
 *
 *-------------------------------------------------------------------------
 */
