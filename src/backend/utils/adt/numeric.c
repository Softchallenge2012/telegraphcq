 ...
 *	1998 Jan Wieck
 *
 * $Header: /project/eecs/db/cvsroot/postgres/src/backend/utils/adt/numeric.c,v 1.3 2004/03/24 08:11:12 chungwu Exp $
 *
 * ----------
 */
...
exp_var(NumericVar *arg, NumericVar *result)
{
	 ...
	 * We run the series until the terms fall below the global_rscale
	 * limit.
	 */
