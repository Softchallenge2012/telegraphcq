 ...
 *
 * IDENTIFICATION
 *	  $Header: /project/eecs/db/cvsroot/postgres/src/backend/utils/cache/syscache.c,v 1.6 2004/03/24 08:11:13 chungwu Exp $
 *
 * NOTES
...
static const struct cachedesc cacheinfo[] = {
	...
	{WrapperRelationName,		/* WRAPPERNAME */
		WrapperNameIndex,
		0,
		1,
		{
			Anum_pg_tcq_wrapper_wrappername,
			0,
			0,
			0
	}},
	{WrapperRelationName,		/* WRAPPEROID */
		WrapperOidIndex,
		0,
		1,
		{
	...
	{WrapperUsageRelationName,	/* WRAPPERUSAGE */
		WrapperUsageByTableIndex,
		0,
		2,
		{
			Anum_pg_tcq_wrapper_usage_wrapperoid,
			Anum_pg_tcq_wrapper_usage_streamoid,
			0,
			0
		}
	}
