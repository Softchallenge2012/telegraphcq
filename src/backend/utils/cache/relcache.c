 ...
 *
 * IDENTIFICATION
 *	  $Header: /project/eecs/db/cvsroot/postgres/src/backend/utils/cache/relcache.c,v 1.10 2005/01/23 23:26:58 yangsta Exp $
 *
 *-------------------------------------------------------------------------
 */
/*
					   ...
					   Relation relation)
{
	...
	constr->ts_attrnum = TCQTSATTRNOP;	/* @dtstampSK */
	...
	while (HeapTupleIsValid(pg_attribute_tuple = systable_getnext(pg_attribute_scan)))
	{
		...
		if (strcmp(NameStr(attp->attname), TCQTSATTRNAME) == 0) /* @BdtstampSK */
		{
			constr->ts_attrnum = attp->attnum - 1;
		}						/* @EdtstampSK */
	 ...
	 */
	if (constr->has_not_null || ndef > 0 ||		/* @dtcqSK */
		relation->rd_rel->relchecks || tc_has_timestamp(constr))		/* @dtcqSK */
	{
						   ...
						   bool nailit)
{
	...
	rel->rd_rel->reloverloadtype = 0; // TODO yang change this to OVERLOAD_NONE (change to SYNOPSIS_NONE) and change reloverloadtype to relsynopsis
	rel->rd_rel->reloverloadparam1 = 0;
	rel->rd_rel->reloverloadparam2 = 0;
	rel->rd_rel->reloverloadparam3 = 0;
	rel->rd_rel->reloverloadparam4 = 0;
	rel->rd_rel->reloverloadparam5 = 0;
	rel->rd_rel->reloverloadparam6 = 0;
	rel->rd_rel->reloverloadparam7 = 0;
	rel->rd_rel->reloverloadparam8 = 0;
