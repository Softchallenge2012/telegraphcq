 ...
 *
 * IDENTIFICATION
 *	  $Header: /project/eecs/db/cvsroot/postgres/src/backend/utils/mb/conversion_procs/latin2_and_win1250/latin2_and_win1250.c,v 1.2 2004/03/24 08:11:16 chungwu Exp $
 *
 *-------------------------------------------------------------------------
 */
