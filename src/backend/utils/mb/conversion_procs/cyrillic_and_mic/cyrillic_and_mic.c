 ...
 *
 * IDENTIFICATION
 *	  $Header: /project/eecs/db/cvsroot/postgres/src/backend/utils/mb/conversion_procs/cyrillic_and_mic/cyrillic_and_mic.c,v 1.2 2004/03/24 08:11:16 chungwu Exp $
 *
 *-------------------------------------------------------------------------
 */
