 ...
 *
 * IDENTIFICATION
 *	  $Header: /project/eecs/db/cvsroot/postgres/src/backend/utils/init/postinit.c,v 1.3 2004/03/24 08:11:15 chungwu Exp $
 *
 *
 *-------------------------------------------------------------------------
 */
...
InitCommunication(void)
{
	...
	if (!IsUnderPostmaster)		/* postmaster already did this */
	{
		 ...
		 * backend. Create private "shmem" and semaphores.	Force
		 * MaxBackends to 1 so that we don't allocate more resources than
		 * necessary.
		 */
