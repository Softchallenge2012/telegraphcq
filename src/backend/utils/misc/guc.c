 ...
 *
 * $Header: /project/eecs/db/cvsroot/postgres/src/backend/utils/misc/guc.c,v 1.39 2005/07/26 20:00:30 phred Exp $
 *
...
#include "telegraphcq/wrapch.h" /* @dtcqSK */
...
/** Variables in backend/utils/init/globals.c */
extern bool enable_eddy;										 /* @dstemsAD */
extern bool enable_smart_routing;								 /* @dstemsAD */
...
/*	{ */
/*		"enable_hashagg", PGC_USERSET, &enable_hashagg, true, NULL */
/*	}, */
	...
	{
		{"enable_eddy", PGC_USERSET}, &enable_eddy,
		false, NULL, NULL
	},
	{
		{"enable_smart_routing", PGC_USERSET}, &enable_smart_routing,
		false, NULL, NULL
	},
	{
		{"enable_memory_debugging", PGC_USERSET}, &enable_memory_debugging,
		false, NULL, NULL
	},
	{
		{"enable_hifi", PGC_USERSET}, &enable_hifi,
		false, NULL, NULL
	},
	{
		{"fstem_pushfilter", PGC_USERSET}, &fstempushfilter,
		false, NULL, NULL
	},
	{
		{"cqeddy_printtuplepath", PGC_USERSET}, &cqeddyprinttuplepath,
		false, NULL, NULL
	},

   	{
		{"elog_transactions", PGC_USERSET}, &elog_transactions,
		false, NULL, NULL
	},

   	{
		{"load_shedding_disable_kept_summaries", PGC_POSTMASTER}, 
            &load_shedding_disable_kept_summaries,
		false, NULL, NULL
	},

	{
		{"tcq_show_punct_in_output", PGC_POSTMASTER}, 
            &tcq_show_punct_in_output,
		false, NULL, NULL
	},
			...
			ConfigureNamesInt[] =
{
	...
	{
		{"cqeddy_checkplanqiters", PGC_POSTMASTER}, &cqeddycheckplanqiters,
		1, 1, INT_MAX, NULL, NULL
	},
	{
		{"cqeddy_checkcontrolqiters", PGC_POSTMASTER}, &cqeddycheckcontrolqiters,
		1, 1, INT_MAX, NULL, NULL
	},
	{
		{"cqeddy_checkcancelediters", PGC_POSTMASTER}, &cqeddycheckcancelediters,
		1, 1, INT_MAX, NULL, NULL
	},
	{
		{"cqeddy_fixedplan", PGC_POSTMASTER}, &cqeddyfixedplan,
		-1, -1, INT_MAX, NULL, NULL
	},
	{
		{"tcqresultqsize", PGC_POSTMASTER}, &tcqresultqsize,
		RESULTQSIZE, -1, INT_MAX, NULL, NULL
	},
	{
		{"tcqrecursiveresultqsize", PGC_POSTMASTER}, &tcqrecursiveresultqsize,
		RECURSIVERESULTQSIZE, -1, INT_MAX, NULL, NULL
	},
	...
	/* @BdfluxMS */
	{
		{"fluxport", PGC_POSTMASTER}, &fluxPort,
		5534, 0, 20000, NULL, NULL
	},

	{
		{"total_machines", PGC_POSTMASTER}, &total_machines,
		1, 1, 8, NULL, NULL
	},

	{
		{"telegraph_nodeid", PGC_POSTMASTER}, &telegraph_nodeid,
		0, 0, 20000, NULL, NULL
	},

	{
		{"report_freq", PGC_POSTMASTER}, &report_freq,
		100000, 10000, 100000000, NULL, NULL
	},

	{
		{"flux_queue_size", PGC_POSTMASTER}, &flux_queue_size,
		4096, 1024, 8192, NULL, NULL
	},

	{
		{"ack_queue_size", PGC_POSTMASTER}, &ack_queue_size,
		1024, 1024, 8192, NULL, NULL
	},

	{
		{"tsb_size", PGC_POSTMASTER}, &tsb_size,
		4096, 8, 32768, NULL, NULL
	},

	{
		{"is_pair", PGC_POSTMASTER}, &is_pair,
		0, 0, FP_TOTAL_PLANS, NULL, NULL
	},

	{
		{"sm_queue_size", PGC_POSTMASTER}, &sm_queue_size,
		4096, 4096, 16384, NULL, NULL
	},
	/* @EdfluxMS */

	{
		{"load_shedding_num_hist_buckets", PGC_POSTMASTER}, 
            &load_shedding_num_hist_buckets,
		100, 1, 10000, NULL, NULL
	},

	{
		{"load_shedding_synopsis_buffer_size", PGC_POSTMASTER}, 
            &load_shedding_synopsis_buffer_size,
		200, 2, 100000, NULL, NULL
	},

	{
		{"load_shedding_square_bucket_width", PGC_POSTMASTER}, 
            &load_shedding_square_bucket_width,
		10, 1, 100000, NULL, NULL
	},

	{
		{"load_shedding_sample_size", PGC_POSTMASTER}, 
            &load_shedding_sample_size,
		100, 1, 1000000, NULL, NULL
	},


	{
		{"load_shedding_synopsis_delay", PGC_POSTMASTER}, 
            &load_shedding_synopsis_delay,
		0, 0, 1000000000, NULL, NULL
	},

	{
		{"load_shedding_synopsis_op_delay", PGC_POSTMASTER}, 
            &load_shedding_synopsis_op_delay,
		0, 0, 1000000000, NULL, NULL
	},

	{
		{"numResultQueues", PGC_POSTMASTER}, &numResultQueues,
		32, 32, 256, NULL, NULL
	},
			...
			ConfigureNamesString[] =
{
	...
	{							/* @BdtcqSK */
		{"telegraphcqdb", PGC_POSTMASTER}, &telegraphcqdb,
		"", NULL, NULL
	},

	{
		{"telegraphcquser", PGC_POSTMASTER}, &telegraphcquser,
		"", NULL, NULL
	},

	{
		{"telegraphcqwchport", PGC_POSTMASTER}, &telegraphcqwchport,
		"", NULL, NULL
	},							/* @EdtcqSK */

	/* @BfluxMS */
	{
		{"gprof_tcqbackend_directory", PGC_POSTMASTER}, &gprof_tcqbackend_directory,
		"/home/mashah/research/pgdb/gprof/tcqbackend", NULL, NULL
	},
	/* @EfluxMS */

	{
		{"node_addr", PGC_POSTMASTER}, &node_addr,
		"192.168.1.100", NULL, NULL
	},

    /* How many seconds between load-shedding summaries?  Will be converted to
     * an Interval. */
	{
		{"load_shedding_synopsis_interval", PGC_POSTMASTER}, 
	...
	{
		{"load_shedding_first_window_start", PGC_POSTMASTER}, 
            &load_shedding_first_window_start,
        "none", NULL, NULL
	},
     /* How many seconds is the wrapper clearinghouse allowed to buffer a tuple
     * for?  Will be converted to an Interval. */
	{
		{"load_shedding_delay_constraint", PGC_POSTMASTER}, 
            &load_shedding_delay_constraint,
        "10 seconds", NULL, NULL
	},
