 ...
 *
 * IDENTIFICATION
 *	  $Header: /project/eecs/db/cvsroot/postgres/src/backend/main/main.c,v 1.9 2004/03/24 08:10:56 chungwu Exp $
 *
 *-------------------------------------------------------------------------
 */
#include "postgres.h"
...
main(int argc, char *argv[])
{
	...
	exit(PostgresMain(argc, new_argv, pw_name_persist));		/* @dtcqSK */
}
