 ...
 *
 * $Header: /project/eecs/db/cvsroot/postgres/src/bin/psql/tab-complete.c,v 1.7 2004/03/24 08:11:26 chungwu Exp $
 */
...
psql_completion(char *text, int start, int end)
{
	...
	static char *pgsql_variables[] = {
		...
		"enable_eddy",			/* @dstemsAD */
		"enable_smart_routing", /* @dstemsAD */
