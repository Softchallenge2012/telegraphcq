 ...
 *
 * $Id: pg_list.h,v 1.7 2005/11/25 20:09:23 rizvi Exp $
 *
 *-------------------------------------------------------------------------
 */
#ifndef PG_LIST_H
...
extern int	ptrMemberWhich(void *datum, List *list);
