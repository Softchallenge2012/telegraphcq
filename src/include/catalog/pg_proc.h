 ...
 *
 * $Id: pg_proc.h,v 1.25 2005/06/13 02:59:28 phred Exp $
 *
 * NOTES
...
/* XXX Hacks for Flux, sorry. These are temporary. */
DATA(insert OID = 791 (  int4count_w		   PGNSP PGUID 12 f f t f i 1 23 "23"  int4count_w - _null_ ));
DESCR("streaming count (internal)");
DATA(insert OID = 792 (  first_url_agg		   PGNSP PGUID 12 f f t f i 2 1043 "1043 1043"  first_url_agg - _null_ ));
DESCR("streaming url agg (internal)");
...
DATA(insert OID = 1327 (  interval_div_interval		 PGNSP PGUID 12 f f t f i 2 701 "1186 1186"  interval_div_interval - _null_ ));
DESCR("divide two intervals");
...
/* TelegraphCQ wrapper functions. */
DATA(insert OID = 9700 (  csv_init	PGNSP PGUID 12 f f t f i 1 16  "23" csv_init - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9701 (  csv_next	PGNSP PGUID 12 f f t f i 1 16 "23"	csv_next - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9702 (  csv_done	PGNSP PGUID 12 f f t f i 1 16 "23"	csv_done - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9703 (  wtime			PGNSP PGUID 12 t f f f i 1 1114  "2276"	aggregate_dummy - _null_ ));
DATA(insert OID = 9704 (  tcq_wtime	PGNSP PGUID 12 f f f f i 1  1114 "2276"	tcq_wtime - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9705 (  realtime			PGNSP PGUID 12 t f f f i 1 1114  "2276"	aggregate_dummy - _null_ ));
DATA(insert OID = 9706 (  tcq_realtime	PGNSP PGUID 12 f f f f i 1  1114 "2276"	tcq_realtime - _null_ ));
DESCR("(internal)");

DATA(insert OID = 9710 (  quik_dump_table	PGNSP PGUID 12 f f t f i 2 16 "2275 2275"	quik_dump_table - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9711 (  quik_init	PGNSP PGUID 12 f f t f i 1 16 "23"	quik_init - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9712 (  quik_next	PGNSP PGUID 12 f f t f i 1 16 "23"	quik_next - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9713 (  quik_done	PGNSP PGUID 12 f f t f i 1 16 "23"	quik_done - _null_ ));
DESCR("(internal)");



/* (TelegraphCQ) Functions in histogram.c */
/* OIDs used for arguments: 
 *  23 == integer
 *  2275 == cstring
 *  2501 == mhist
 */
DATA(insert OID = 9757 (  mhist_in	PGNSP PGUID 12 f f t f i 1 2501  "2275" mhist_in - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9758 (  mhist_out	PGNSP PGUID 12 f f t f i 1 2275  "2501" mhist_out - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9759 (  mhist_to_table	PGNSP PGUID 12 f f t f i 1 16  "2501" mhist_to_table - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9760 (  mhist_equijoin	PGNSP PGUID 12 f f t f i 1 2501  "2501 2275 2501 2275" mhist_equijoin - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9761 (  mhist_union	PGNSP PGUID 12 f f t f i 1 2501  "2501 2501" mhist_union - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9762 (  mhist_slice	PGNSP PGUID 12 f f t f i 1 2501  "2501 2275 23" mhist_slice - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9763 (  mhist_project	PGNSP PGUID 12 f f t f i 1 2501  "2501 2275" mhist_project - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9764 (  mhist_crossprod	PGNSP PGUID 12 f f t f i 1 2501  "2501 2501" mhist_crossprod - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9765 (  mhist_eq_selection	PGNSP PGUID 12 f f t f i 1 2501  "2501 2275 2275" mhist_eq_selection - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9766 (  mhist_project_many	PGNSP PGUID 12 f f t f i 1 2501  "2501 2275" mhist_project_many - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9767 (  square_mhist_in	PGNSP PGUID 12 f f t f i 1 2501  "2275" square_mhist_in - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9768 (  get_cached_mhist	PGNSP PGUID 12 f f t f i 1 2501  "2275" get_cached_mhist - _null_ ));
DESCR("(internal)");
/* 9769-9783 are wavelet stuff. */
DATA(insert OID = 9785 (  mhist_from_table	PGNSP PGUID 12 f f t f i 3 2501  "2275 2275 2275" mhist_from_table - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9786 (  mhist_range_selection	PGNSP PGUID 12 f f t f i 1 2501  "2501 2275 23 23" mhist_range_selection - _null_ ));
DESCR("(internal)");


/* (TelegraphCQ) Functions in wavelet.c */
/* OIDs used for arguments:
 *  23 == integer
 *  2275 = cstring
 *  2502 = wavelet
...
DATA(insert OID = 9769 (  wcs_in	PGNSP PGUID 12 f f t f i 6 2502  "2275 2275 2275 2275 23 23" wcs_in - _null_ ));
/*DATA(insert OID = 9769 (  wcs_in	PGNSP PGUID 12 f f t f i 4 2502  "2275 2275 23 23" wcs_in - _null_ ));*/
DESCR("(internal)");
DATA(insert OID = 9781 (  wcs_out	PGNSP PGUID 12 f f t f i 1 2275  "2502" wcs_out - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9770 (  wcs_projection	PGNSP PGUID 12 f f t f i 2 2502  "2502 2275" wcs_projection - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9783 (  wcs_selection	PGNSP PGUID 12 f f t f i 3 2502  "2502 2275 2275" wcs_selection - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9772 (  wcs_equijoin	PGNSP PGUID 12 f f t f i 5 2502  "2502 2502 2275 23 23" wcs_equijoin - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9773 (  wcs_to_mhist	PGNSP PGUID 12 f f t f i 1 2501  "2502" wcs_to_mhist - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9774 (  wcs_union	PGNSP PGUID 12 f f t f i 2 2502  "2502 2502" wcs_union - _null_ ));
DESCR("(internal)");
DATA(insert OID = 9775 (  get_cached_wcs	PGNSP PGUID 12 f f t f i 1 2502  "2275" get_cached_wcs - _null_ ));
DESCR("(internal)");
//DATA(insert OID = 9774 (  wavelet_crossprod	PGNSP PGUID 12 f f t f i 1 2502  "2502 2502" wavelet_crossprod - _null_ ));
//DESCR("(internal)");
//DATA(insert OID = 9775 (  wavelet_eq_selection	PGNSP PGUID 12 f f t f i 1 2502  "2502 2275 2275" wavelet_eq_selection - _null_ ));
//DESCR("(internal)");
...
//DATA(insert OID = 9768 (  wavelet_in	PGNSP PGUID 12 f f t f i 1 2502  "2275" wavelet_in - _null_ ));
//DESCR("(internal)");
//DATA(insert OID = 9769 (  wavelet_out	PGNSP PGUID 12 f f t f i 1 2275  "2502" wavelet_out - _null_ ));
//DESCR("(internal)");
//DATA(insert OID = 9770 (  wavelet_to_table	PGNSP PGUID 12 f f t f i 1 16  "2502" wavelet_to_table - _null_ ));
//DESCR("(internal)");
//DATA(insert OID = 9771 (  wavelet_equijoin	PGNSP PGUID 12 f f t f i 1 2502  "2502 2275 2502 2275" wavelet_equijoin - _null_ ));
//DESCR("(internal)");
//DATA(insert OID = 9772 (  wavelet_union	PGNSP PGUID 12 f f t f i 1 2502  "2502 2502" wavelet_union - _null_ ));
//DESCR("(internal)");
//DATA(insert OID = 9773 (  wavelet_project	PGNSP PGUID 12 f f t f i 1 2502  "2502 2275" wavelet_project - _null_ ));
//DESCR("(internal)");
//DATA(insert OID = 9774 (  wavelet_crossprod	PGNSP PGUID 12 f f t f i 1 2502  "2502 2502" wavelet_crossprod - _null_ ));
//DESCR("(internal)");
//DATA(insert OID = 9775 (  wavelet_eq_selection	PGNSP PGUID 12 f f t f i 1 2502  "2502 2275 2275" wavelet_eq_selection - _null_ ));
//DESCR("(internal)");
////DATA(insert OID = 9762 (  wavelet_slice	PGNSP PGUID 12 f f t f i 1 2502  "2502 2275 23" wavelet_slice - _null_ ));
////DESCR("(internal)");
////DATA(insert OID = 9766 (  wavelet_project_many	PGNSP PGUID 12 f f t f i 1 2501  "2501 2275" wavelet_project_many - _null_ ));
////DESCR("(internal)");
////DATA(insert OID = 9767 (  square_wavelet_in	PGNSP PGUID 12 f f t f i 1 2501  "2275" square_wavelet_in - _null_ ));
////DESCR("(internal)");

///////////////////

/* Functions in shedding.c */
DATA(insert OID = 9780 (  test_sampling_speed	PGNSP PGUID 12 f f t f i 1 701  "23" test_sampling_speed - _null_ ));
DESCR("(internal)");
