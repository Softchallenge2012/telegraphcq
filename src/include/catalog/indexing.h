 ...
 *
 * $Id: indexing.h,v 1.4 2003/07/16 09:42:50 sailesh Exp $
 *
 *-------------------------------------------------------------------------
 */
#ifndef INDEXING_H
...
#define WrapperNameIndex			"pg_tcq_wrapper_name_index"
#define WrapperOidIndex				"pg_tcq_wrapper_oid_index"
#define WrapperUsageByTableIndex	"pg_tcq_wrapper_usage_by_table_index"
...
/* TelegraphCQ catalogs												 @BdtcqSK */
DECLARE_UNIQUE_INDEX(pg_tcq_wrapper_name_index on pg_tcq_wrapper using btree(wrappername name_ops));
DECLARE_UNIQUE_INDEX(pg_tcq_wrapper_oid_index on pg_tcq_wrapper using btree(oid oid_ops));
DECLARE_UNIQUE_INDEX(pg_tcq_wrapper_usage_by_table_index on pg_tcq_wrapper_usage using btree(wrapperoid oid_ops, streamoid oid_ops));
 /* @EdtcqSK */
