 ...
 *
 * $Id: pg_aggregate.h,v 1.4 2005/06/13 02:59:28 phred Exp $
 *
 * NOTES
...
DATA(insert ( 9703	tcq_wtime	tcq_wtime		1114	_null_ ));
DATA(insert ( 9705	tcq_realtime	tcq_realtime		1114	_null_ ));
