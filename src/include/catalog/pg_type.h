 ...
 *
 * $Id: pg_type.h,v 1.7 2005/03/10 02:20:10 phred Exp $
 *
 * NOTES
...
/* OIDS 2500-2599: TelegraphCQ data types */

//                       name      nmspc owner len
//                                                byval
//                                                  type
//                                                    isdef
//                                                      delim
//                                                           rel id
//                                                             elem
//                                                               in       typout typalign typstor typ!null typbasetyp typtypmod ...
DATA(insert OID = 2501 ( mhist	   PGNSP PGUID -1 f b t \054 0 0 mhist_in mhist_out i x f 0 -1 0 _null_ _null_ ));
DESCR("a multidimensional histogram with variable-sized buckets");
#define MHISTOID        2501

DATA(insert OID = 2502 ( wcs	   PGNSP PGUID -1 f b t \054 0 0 wcs_in wcs_out i x f 0 -1 0 _null_ _null_ ));
DESCR("wavelets wavelets n more wavelets");
#define WCSTYPE         2502

DATA(insert OID = 2503 ( fghist	   PGNSP PGUID -1 f b t \054 0 0 square_mhist_in mhist_out i x f 0 -1 0 _null_ _null_ ));
DESCR("a multidimensional histogram with a fixed grid of buckets");
#define REGHISTOID        2503


//DATA(insert OID = 2502 ( wavelet	   PGNSP PGUID -1 f b t \054 0 0 wavelet_in wavelet_out i x f 0 -1 0 _null_ _null_ ));
//DESCR("wavelets wavelets wavelets");
//#define WAVELET         2502

/* DEPRECATED
DATA(insert OID = 2502 ( histogram	   PGNSP PGUID -1 f b t \054 0 0 hist_in hist_out i x f 0 -1 0 _null_ _null_ ));
DESCR("a multidimensional histogram with equal-sized buckets");
#define HISTOGRAMOID        2502
*/
