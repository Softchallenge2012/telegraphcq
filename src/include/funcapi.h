 ...
 *
 * $Id: funcapi.h,v 1.3 2004/07/30 20:54:36 owenc Exp $
 *
 *-------------------------------------------------------------------------
 */
#ifndef FUNCAPI_H
...
Datum DatumFromTypeInstance(AttInMetadata *aim,
					  int colno,
					  char *typeInstance,
					  MemoryContext ctx, bool * wasNull);

char *CStringFromTuple(AttOutMetadata * aom,
				 HeapTuple tup, int attno,
				 bool *isNull,
				 MemoryContext ctx);

AttOutMetadata *TupleDescGetAttOutMetadata(TupleDesc tupdesc);
