 ...
 *
 * $Id: htup.h,v 1.9 2005/05/04 02:28:39 phred Exp $
 *
 *-------------------------------------------------------------------------
 */
#ifndef HTUP_H
...
#define HEAP_ISPUNCT            0x0020  /* Is a stream punctuation tuple */
...
/* TelegraphCQ extensions: */
#define HeapTupleIsPunct(tuple) \
		(((tuple)->t_data->t_infomask & HEAP_ISPUNCT) != 0)
