 ...
 *
 * $Id: relscan.h,v 1.3 2004/03/24 08:11:28 chungwu Exp $
 *
 *-------------------------------------------------------------------------
 */
#ifndef RELSCAN_H
...
typedef struct HeapScanDescData
{
	...
	PgStat_Info rs_pgstat_info; /* statistics collector hook */
        ...
        /* add fields for working with progress array */
        HeapScanID heapScanID; /* The scan module's id for the relation */
