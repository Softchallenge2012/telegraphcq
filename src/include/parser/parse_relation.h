 ...
 *
 * $Id: parse_relation.h,v 1.7 2005/06/13 02:59:29 phred Exp $
 *
 *-------------------------------------------------------------------------
 */
...
extern List *colnameToVarList(ParseState *pstate, char *colname);
...
extern RangeTblRef *rt_getrtr(List *rtbl, RangeTblEntry *rte);	/* @dwndwSK */
