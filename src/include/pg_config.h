 ...
 *
 * $Id: pg_config.h.in,v 1.1.1.2 2003/04/17 23:01:20 sailesh Exp $
 */
...
#define PG_VERSION "2.1"
/* A canonical string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 2.1 on x86_64-unknown-linux-gnu, compiled by GCC gcc (Ubuntu 5.4.0-6ubuntu1~16.04.9) 5.4.0 20160609"
