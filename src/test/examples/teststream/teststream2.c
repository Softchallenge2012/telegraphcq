...
PG_FUNCTION_INFO_V1(teststream2_init);
PG_FUNCTION_INFO_V1(teststream2_next);
PG_FUNCTION_INFO_V1(teststream2_done);
Datum
			teststream2_init(PG_FUNCTION_ARGS);
Datum
			teststream2_next(PG_FUNCTION_ARGS);
Datum
			teststream2_done(PG_FUNCTION_ARGS);
