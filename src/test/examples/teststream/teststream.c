...
PG_FUNCTION_INFO_V1(teststream_init);
PG_FUNCTION_INFO_V1(teststream_next);
PG_FUNCTION_INFO_V1(teststream_done);
Datum
			teststream_init(PG_FUNCTION_ARGS);
Datum
			teststream_next(PG_FUNCTION_ARGS);
Datum
			teststream_done(PG_FUNCTION_ARGS);
