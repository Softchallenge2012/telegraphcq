...
// $Id: HttpRequestMessage.java,v 1.2 2003/07/17 05:19:12 sailesh Exp $
...
public class HttpRequestMessage extends HttpEntityMessage {
	...
	if ((major >= 1) && ! hasHeader(H_HOST)) {
	    String h = 
		((((url.getPort()==80) && url.getProtocol().equals("http")) || 
		  ((url.getPort()==443) && url.getProtocol().equals("https"))||
		  (url.getPort() == -1))
		 ? url.getHost()
